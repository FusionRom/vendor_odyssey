...
ifndef ODYSSEY_BUILD_TYPE
    ODYSSEY_BUILD_TYPE := UNOF
    PLATFORM_VERSION_CODENAME := UNOF
    ODYSSEY_POSTFIX := -$(shell date +"%Y%m%d-%H%M")
endif

# Set all versions
ODYSSEY_VERSION := Fusion-$(PRODUCT_VERSION_MAJOR).$(PRODUCT_VERSION_MINOR).$(PRODUCT_VERSION_MAINTENANCE)-$(ODYSSEY_BUILD_TYPE)$(ODYSSEY_POSTFIX)
ODYSSEY_MOD_VERSION := Fusion-$(ODYSSEY_BUILD)-$(PRODUCT_VERSION_MAJOR).$(PRODUCT_VERSION_MINOR).$(PRODUCT_VERSION_MAINTENANCE)-$(ODYSSEY_BUILD_TYPE)$(ODYSSEY_POSTFIX)

PRODUCT_PROPERTY_OVERRIDES += \
    BUILD_DISPLAY_ID=$(BUILD_ID) \
    odyssey.ota.version=$(PRODUCT_VERSION_MAJOR).$(PRODUCT_VERSION_MINOR).$(PRODUCT_VERSION_MAINTENANCE) \
    ro.fusion.version=$(ODYSSEY_VERSION) \
